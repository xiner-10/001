...
let userID = "56d73b43-0f5e-44fd-9052-e8a62d599181";

const proxyIPs = ["34.41.252.92"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
const cn_hostnames = [''];
